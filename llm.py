...
def analyze_query_with_llm(query, chat_history):
    ...
    2. **Set Profile Limit**: Determine the number of profiles to return. If not mentioned in the query, default to 10.
    ...
    try:
        ...
        return {"tools": [], "limit": 10, "conversational": False, "error": True}  # Default fallback
